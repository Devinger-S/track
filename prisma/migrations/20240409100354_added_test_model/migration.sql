...
CREATE TABLE "Activity" (
    "id" TEXT NOT NULL DEFAULT concat('act_', replace((gen_random_uuid())::text, '-'::text, ''::text)),
    "name" TEXT,
...
-- CreateTable
CREATE TABLE "Client" (
    "id" TEXT NOT NULL DEFAULT concat('cli_', replace((gen_random_uuid())::text, '-'::text, ''::text)),
    "name" TEXT NOT NULL,
    "color" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Project" (
    "id" TEXT NOT NULL DEFAULT concat('prj_', replace((gen_random_uuid())::text, '-'::text, ''::text)),
    "name" TEXT NOT NULL,
    "color" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Tenant" (
    ...
    "inviteKey" TEXT NOT NULL DEFAULT replace((gen_random_uuid())::text, '-'::text, ''::text),
